...
def create_order_endpoint(payload: OrderCreate, db: Session = Depends(get_db)) -> OrderDetailResponse:
...
def get_order_endpoint(order_id: UUID, db: Session = Depends(get_db)) -> OrderDetailResponse:
    """Get one order by id."""
